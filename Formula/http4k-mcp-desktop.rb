class Http4kMcpDesktop < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/http4k/mcp-desktop/releases/download/v6.1.0.0/http4k-mcp-desktop-6.1.0.0-macos-x86_64"
      sha256 "REPLACE_WITH_ARM_SHA256"
    else
      url "https://github.com/http4k/mcp-desktop/releases/download/v6.1.0.0/http4k-mcp-desktop-6.1.0.0-macos-arm64"
