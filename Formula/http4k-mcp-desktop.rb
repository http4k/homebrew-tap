class Http4kMcpDesktop < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      url "https://github.com/http4k/mcp-desktop/releases/download/0.0.1/http4k-mcp-desktop-0.0.1-macos-x86_64"
  ...
  def install
    if Hardware::CPU.arm?
      mv "http4k-mcp-desktop-0.0.1-macos-arm64", "http4k-mcp-desktop"
    else
